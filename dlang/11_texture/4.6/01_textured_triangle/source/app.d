...
void CreateTexture(string filename, int width, int height){
  ...
  glTextureParameteri(gMesh.mTexID, GL_TEXTURE_MIN_FILTER,GL_LINEAR);	
  glTextureParameteri(gMesh.mTexID, GL_TEXTURE_MAG_FILTER,GL_LINEAR);	
  glTextureParameteri(gMesh.mTexID, GL_TEXTURE_WRAP_S,GL_CLAMP_TO_BORDER);	
  glTextureParameteri(gMesh.mTexID, GL_TEXTURE_WRAP_T,GL_CLAMP_TO_BORDER);	
}
