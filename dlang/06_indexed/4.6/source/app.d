...
void VertexSpecification(){
    ...
    */
    ...
    // Associate the Vertex Buffer (VBO) with our VAO
    glVertexArrayVertexBuffer(gMesh.mVAO,0,gMesh.mVBO,0,GLfloat.sizeof*3); 

    // Element Buffer Object (IBO) (a.k.a. Index Buffer Object (IBO))
    glCreateBuffers(1,&gMesh.mIBO);
    // Create storage for the Element Buffer Object
    glNamedBufferStorage(gMesh.mIBO, mIndexData.length* GLuint.sizeof, mIndexData.ptr, 0);
    // Associate Index buffer with the VAO
    glVertexArrayElementBuffer(gMesh.mVAO, gMesh.mIBO);
